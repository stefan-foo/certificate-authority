...
public class Certificate extends TableImpl<CertificateRecord> {
     ...
     */
    public final TableField<CertificateRecord, SubjectType> SUBJECT_TYPE = createField(DSL.name("subject_type"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(rs.elfak.caprovider.db.enums.SubjectType.class), this, "");
