...
public class CertificateRequest extends TableImpl<CertificateRequestRecord> {
     ...
     */
    public final TableField<CertificateRequestRecord, RequestType> REQUEST_TYPE = createField(DSL.name("request_type"), SQLDataType.VARCHAR.asEnumDataType(rs.elfak.ocspresponder.db.enums.RequestType.class), this, "");
     ...
     */
    public final TableField<CertificateRequestRecord, RequestStatus> STATUS = createField(DSL.name("status"), SQLDataType.VARCHAR.asEnumDataType(rs.elfak.ocspresponder.db.enums.RequestStatus.class), this, "");
